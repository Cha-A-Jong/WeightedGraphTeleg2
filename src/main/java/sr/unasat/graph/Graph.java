...
public class Graph {
    ...
    // je gaat een constructor aanmaken
    public Graph(){
        ...
        nVertex = 0;
        nVertexGraph = 0;
        for(int index=0; index<MAX_HUBS; index++) //set adjacency
            for(int b=0; b<MAX_HUBS; b++) //matrix to 0
...
//                bfsQueue.showQueue();
    ...
    public void dfsSearch(Hubs startingHub, Hubs destinationHub) {
        ...
        displayVertexHubsName(startingVertexIndex);
        System.out.print(newline + " to " + newline
